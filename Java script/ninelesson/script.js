...
<body>
    ...
    <form id="registerForm"> 
     ...
     <div id="parent" style="padding: 30px; border:20px solid black">
        Родитель
        <button id="child">Нажми</button>
    </div>
    <button id = "btn">Кнопка 1</button>
    <button id = "btn">Кнопка 2 </button>
    <button id = "btn">Кнопка 3 </button> 
    ...
    <input type="text" id="textInput" placeholder="Введите задачу">
